  ...
  return (
    <div className="skills">
      ...
      <div className="title">
        <h3>Skills</h3>
        <p>
          Note: I believe that &ldquo;SKILLS&ldquo; are primarily based on
          personal preference,
          and anyone can learn with enough time.<br />
          This section should be titled `&ldquo;PREFERENCES&ldquo; instead.
        </p>
      </div>
